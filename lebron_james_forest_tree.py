...
from data_analysis import james_df
...
james_random_forest = james_df.copy(deep=True)

# add labels for below or above each of the below 1200-2200 in 100 increments >= points 1, else 0
james_random_forest['AboveBelow1200'] = np.where(james_random_forest['PTS'] >= 1200, 1, 0)
james_random_forest['AboveBelow1300'] = np.where(james_random_forest['PTS'] >= 1300, 1, 0)
james_random_forest['AboveBelow1400'] = np.where(james_random_forest['PTS'] >= 1400, 1, 0)
james_random_forest['AboveBelow1500'] = np.where(james_random_forest['PTS'] >= 1500, 1, 0)
james_random_forest['AboveBelow1600'] = np.where(james_random_forest['PTS'] >= 1600, 1, 0)
james_random_forest['AboveBelow1700'] = np.where(james_random_forest['PTS'] >= 1700, 1, 0)
james_random_forest['AboveBelow1800'] = np.where(james_random_forest['PTS'] >= 1800, 1, 0)
james_random_forest['AboveBelow1900'] = np.where(james_random_forest['PTS'] >= 1900, 1, 0)
james_random_forest['AboveBelow2000'] = np.where(james_random_forest['PTS'] >= 2000, 1, 0)
james_random_forest['AboveBelow2100'] = np.where(james_random_forest['PTS'] >= 2100, 1, 0)
james_random_forest['AboveBelow2200'] = np.where(james_random_forest['PTS'] >= 2200, 1, 0)
...
print('LeBron James : Decision Tree | Random Forest with Depths of 1-2 and Subtrees of 1-5.')
...
input_data = james_random_forest[['MP', 'FGA', 'G']]
# define x as input data values and y as label values for above below points
X = input_data.values
y = james_random_forest['AboveBelow1200'].values
...
avg_instance = np.asmatrix([player_df_sum_avg.iloc[0, 1], player_df_sum_avg.iloc[0, 2],
                                        player_df_sum_avg.iloc[0, 3]])
...
if decision_tree_label < 1:
    print('LeBron James will score below ' + str(points) + ' points next season.')
...
# else decision tree label not less than 1, ie positive label > points total, print strings and accuracy
    ...
    print('LeBron James will score above ' + str(points) + ' points next season.')
    print('Accuracy of decision tree = ' + str((float(round(decision_tree_accuracy, 4)))) + '%')
...
james_tree_df = pd.DataFrame(columns=['Subtrees', 'Depth', 'Label'])
james_tree_df['Subtrees'] = subtrees_list
james_tree_df['Depth'] = depth_list
james_tree_df['Label'] = label_list
# define x, y and text, annotate text with label column
x = james_tree_df['Depth']
y = james_tree_df['Subtrees']
text = james_tree_df['Label']
...
plt.ylabel('Subtrees')
plt.title('LeBron James Random Forrest Classifier Scatter Plot ' + str(points) + ' Points')
plt.savefig('Random Forest/LeBron James/LeBron James Random Forrest Classifier Scatter Plot '
...
# else sum_label = length of label list/2 ie it is a split undecided if above or below
    ...
    print('It is undecided if LeBron James will score above or below ' + str(points) + ' points next season.')
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = james_random_forest['AboveBelow1300'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = james_random_forest['AboveBelow1400'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = james_random_forest['AboveBelow1500'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = james_random_forest['AboveBelow1600'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = james_random_forest['AboveBelow1700'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = james_random_forest['AboveBelow1800'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = james_random_forest['AboveBelow1900'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = james_random_forest['AboveBelow2000'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = james_random_forest['AboveBelow2100'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = james_random_forest['AboveBelow2200'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
print('Based off of the Decision Tree predictions and average games, minutes, and field goal attempts.\n'
      'A conservative prediction is that LeBron James will score between '
