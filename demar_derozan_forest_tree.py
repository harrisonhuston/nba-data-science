...
from data_analysis import derozan_df
...
derozan_random_forest = derozan_df.copy(deep=True)

# add labels for below or above each of the below 1200-2200 in 100 increments >= points 1, else 0
derozan_random_forest['AboveBelow1200'] = np.where(derozan_random_forest['PTS'] >= 1200, 1, 0)
derozan_random_forest['AboveBelow1300'] = np.where(derozan_random_forest['PTS'] >= 1300, 1, 0)
derozan_random_forest['AboveBelow1400'] = np.where(derozan_random_forest['PTS'] >= 1400, 1, 0)
derozan_random_forest['AboveBelow1500'] = np.where(derozan_random_forest['PTS'] >= 1500, 1, 0)
derozan_random_forest['AboveBelow1600'] = np.where(derozan_random_forest['PTS'] >= 1600, 1, 0)
derozan_random_forest['AboveBelow1700'] = np.where(derozan_random_forest['PTS'] >= 1700, 1, 0)
derozan_random_forest['AboveBelow1800'] = np.where(derozan_random_forest['PTS'] >= 1800, 1, 0)
derozan_random_forest['AboveBelow1900'] = np.where(derozan_random_forest['PTS'] >= 1900, 1, 0)
derozan_random_forest['AboveBelow2000'] = np.where(derozan_random_forest['PTS'] >= 2000, 1, 0)
derozan_random_forest['AboveBelow2100'] = np.where(derozan_random_forest['PTS'] >= 2100, 1, 0)
derozan_random_forest['AboveBelow2200'] = np.where(derozan_random_forest['PTS'] >= 2200, 1, 0)
...
print('DeMar Derozan : Decision Tree | Random Forest with Depths of 1-2 and Subtrees of 1-5.')
print("Assuming average games (" + str(player_df_sum_avg.iloc[2, 1]) +
      "), minutes (" + str(player_df_sum_avg.iloc[2, 2]) +
      "), and field goal attempts (" + str(player_df_sum_avg.iloc[2, 3]) + ")\n")
...
input_data = derozan_random_forest[['MP', 'FGA', 'G']]
# define x as input data values and y as label values for above below points
X = input_data.values
y = derozan_random_forest['AboveBelow1200'].values
...
avg_instance = np.asmatrix([player_df_sum_avg.iloc[2, 1], player_df_sum_avg.iloc[2, 2],
                                        player_df_sum_avg.iloc[2, 3]])
...
if decision_tree_label < 1:
    print('DeMar Derozan will score below ' + str(points) + ' points next season.')
...
# else decision tree label not less than 1, ie positive label > points total, print strings and accuracy
    ...
    print('DeMar Derozan will score above ' + str(points) + ' points next season.')
    print('Accuracy of decision tree = ' + str((float(round(decision_tree_accuracy, 4)))) + '%')
...
derozan_tree_df = pd.DataFrame(columns=['Subtrees', 'Depth', 'Label'])
derozan_tree_df['Subtrees'] = subtrees_list
derozan_tree_df['Depth'] = depth_list
derozan_tree_df['Label'] = label_list
# define x, y and text, annotate text with label column
x = derozan_tree_df['Depth']
y = derozan_tree_df['Subtrees']
text = derozan_tree_df['Label']
...
plt.ylabel('Subtrees')
plt.title('DeMar Derozan Random Forrest Classifier Scatter Plot ' + str(points) + ' Points')
plt.savefig('Random Forest/DeMar Derozan/DeMar Derozan Random Forrest Classifier Scatter Plot '
...
# else sum_label = length of label list/2 ie it is a split undecided if above or below
    ...
    print('It is undecided if DeMar Derozan will score above or below ' + str(points) + ' points next season.')
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = derozan_random_forest['AboveBelow1300'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = derozan_random_forest['AboveBelow1400'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = derozan_random_forest['AboveBelow1500'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = derozan_random_forest['AboveBelow1600'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = derozan_random_forest['AboveBelow1700'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = derozan_random_forest['AboveBelow1800'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = derozan_random_forest['AboveBelow1900'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = derozan_random_forest['AboveBelow2000'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = derozan_random_forest['AboveBelow2100'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
# define x as input data values and y as label values for above below points
X = input_data.values
y = derozan_random_forest['AboveBelow2200'].values
# split data 50/50 test train
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5)
...
print('Based off of the Decision Tree predictions and average games, minutes, and field goal attempts.\n'
      'A conservative prediction is that DeMar Derozan will score between '
